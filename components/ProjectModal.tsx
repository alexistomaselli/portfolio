  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-slate-800 rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto border border-slate-700 flex flex-col">
        ...
        {/* Project Image Header (Simulation of Device Views) */}
        ...
        <div className="p-6 md:p-10 grid md:grid-cols-3 gap-8">
          <div className="md:col-span-2 space-y-6">
            <div>
              <h4 className="text-lg font-semibold text-white mb-2">Sobre el Proyecto</h4>
            ...
            <div className="pt-4">
               <h4 className="text-lg font-semibold text-white mb-4">Vistas Responsivas</h4>
          ...
          <div className="space-y-6">
             <div className="bg-slate-900 p-6 rounded-xl border border-slate-700">
                <h4 className="text-sm font-bold text-slate-400 uppercase tracking-wider mb-4">Links</h4>
                <a 
                  href={project.url} 
                  target="_blank" 
                ...
                >
                  Ver Sitio Web <ExternalLink size={18} />
                </a>
             </div>
          </div>
        </div>
